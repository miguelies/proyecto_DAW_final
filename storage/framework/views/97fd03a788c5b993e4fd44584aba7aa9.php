      ...
      <div class="row justify-content-center">
        ...
        <div class="card">
            <div class="card-header">
              <h4><?php echo e($Tarea[0]['nombre_actividad']); ?></h4>
              <p>Fecha de cierre: <?php echo e($Tarea[0]['fecha_cierre']); ?> | Hora de cierre: <?php echo e($Tarea[0]['hora_cierre']); ?></p>
            </div>
            <div class="card-body">
              <p><?php echo e($Tarea[0]['descripcion_actividad']); ?></p>
              <?php if($estado==1 && $Tarea[0]['estado_actividades']): ?>
              <form action="../entregar" method="post" enctype="multipart/form-data">
                <?php echo e(csrf_field()); ?>

                <label for="ruta_archivo">Subir Archivo</label>
                <input type="hidden" id="cod_acti" name="cod_acti" class="form-control" value="<?php echo e($Tarea[0]['cod_actividad']); ?>" required>
        ...
        <?php if($admin[0]['administrador']==1): ?>
        <div class="col-md-3">
        <div class="card">
                            ...
                            <div class="card">
                              <div class="card-body">
                                ...
                                <?php echo e(csrf_field()); ?>
                                  ...
                                  <input type="hidden" id="file_name" name="file_name" class="form-control" value="<?php echo e($Archivo[0]->cod_archivos); ?>" required>
                                  <input type="hidden" id="cod_acti" name="cod_acti" class="form-control" value="<?php echo e($Tarea[0]['cod_actividad']); ?>" required>
                                  <button type="submit" class="btn btn-primary btn-lg btn-block">Descargar &#x2B07;</button>
                                </form>
                              </div>
                            </div>
                          </div>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="form-group">
                        <!--Editar una tarea-->
                          ...
                          <input type="text" id="nombre_actividad" name="nombre_actividad" class="form-control" value="<?php echo e($Tarea[0]['nombre_actividad']); ?>" required>
                          <label for="descripcion_actividad">Descripcion</label>
                          <input type="text" id="descripcion_actividad" name="descripcion_actividad" class="form-control" value="<?php echo e($Tarea[0]['descripcion_actividad']); ?>" required>
                          <label for="fecha_cierre">Fecha:</label>
                          <input type="date" id="fecha_cierre" name="fecha_cierre" class="form-control" value="<?php echo e($Tarea[0]['fecha_cierre']); ?>">
                          <label for="hora_cierre">Hora:</label>
                          <input type="time" id="hora_cierre" name="hora_cierre" class="form-control" value="<?php echo e($Tarea[0]['hora_cierre']); ?>">
                          <br>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\Agenda_Virtual\resources\views/Agenda/tareas_grupo_especi.blade.php ENDPATH**/ ?>